...
def IA_lugar_grabacion(user, lugares, top_n=10):
    # Genera una respuesta a partir de un prompt

    promt="Recomiendame solo los nombres de 10 peliculas sin informacion antes ni despues , que hayan sido grabadas en "
...
def IA_same_peliculas(peliculas, top_n=10):
    # Genera una respuesta a partir de un prompt

    promt="Recomiendame solo los nombres de 10 peliculas sin informacion antes ni despues , que sean similares a estas otras peliculas "
